...
export class ClockWeatherCard extends LitElement {
  ...
  private getLocalizedTemperature(): string {
    ...
    const temperatureUnit = null;
    if (temperatureSensor){
      const temperature = temperatureSensor.state !== undefined ? Math.round(+temperatureSensor.state) : null;
    ...
    {
      const temperature = weather.attributes.temperature !== undefined ? Math.round(weather.attributes.temperature) : null;
