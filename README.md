...
| humidity_sensor    | string           | **Optional** | ID of the humidity sensor entity. Used to show the current humidity based on a sensor value                                                                                                 | `true`      |
...
| hide_humidity             | boolean          | **Optional** | Hides the humidity from the today section                                                                                                                                                                                             | `false`   |
